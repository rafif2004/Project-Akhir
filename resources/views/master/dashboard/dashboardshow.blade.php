...
<div class="row">
    <div class="col-lg-4">
        ...
        <div class="card-header">
            ...
            <div class="card-body">
                <p class="mt-3">Nama Siswa = {{ $bacaan->siswa->nama }}</p>
                <p class="mt-3">Kelas = {{ $bacaan->kntl->kelas }}</p>
                <p class="mt-3">Absen = {{ $bacaan->siswa->absen }}</p>
                <p class="mt-3">Poin Bacaan = {{ $bacaan->siswa->poin }}</p>
            </div>
      </div>
    </div>
    <div class="col-lg-8">
